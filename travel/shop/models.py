...
class Event(TimestampMixin):
    ...
    place = models.ForeignKey(Place, related_name='events', on_delete=models.CASCADE, verbose_name='Место')
...
class Order(TimestampMixin):
    ...
    user = models.ForeignKey(MainUser, related_name='orders', on_delete=models.CASCADE, verbose_name='Пользователь')
...
class Ticket(models.Model):
    ...
    uuid = models.UUIDField(default=uuid.uuid4(), unique=True, verbose_name='Билет')
